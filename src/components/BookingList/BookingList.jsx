    ...
    <div className="overflow-x-auto mt-4 rounded-lg shadow">
      <table className="min-w-full border border-gray-200">
        <thead className="bg-gray-100 text-sm sm:text-base">
          <tr>
            <th className="px-2 sm:px-4 py-2 text-left">Guest</th>
            <th className="px-2 sm:px-4 py-2 text-left">Apartment</th>
            <th className="px-2 sm:px-4 py-2">CheckIn</th>
            <th className="px-2 sm:px-4 py-2">CheckOut</th>
        ...
        <tbody className="text-sm sm:text-base">
          {bookings.map((b) => (
            <tr key={b._id} className="border-b">
              <td className="px-2 sm:px-4 py-2">{b.guestName}</td>
              <td className="px-2 sm:px-4 py-2">{b.apartment?.name || "-"}</td>
